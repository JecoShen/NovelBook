...
<template>
  ...
  >
    <div
      ref="contentRef"
      class="desktop-title-bar__content"
    >
      <div class="desktop-title-bar__leading">
        <div
          class="desktop-title-bar__brand desktop-title-bar__drag-surface"
          data-tauri-drag-region
        >
          <span class="i-lucide-feather h-3.5 w-3.5" />
        ...
        <div
          v-if="rendererMenus && presentation === 'full'"
          class="desktop-title-bar__menus"
        >
          <div
          ...
          >
            ...
            <div
              ...
              class="desktop-title-bar__dropdown"
              role="menu"
            >
              <button
        ...
        >
          ...
          >
            <span class="i-lucide-menu h-4 w-4" />
          </button>
          <div
            v-if="openMenu === 'compact'"
            class="desktop-title-bar__dropdown desktop-title-bar__dropdown--compact"
            role="menu"
          >
            <template
              v-for="group in menus"
              :key="group.label"
            >
              <div class="desktop-title-bar__group-label">
                {{ group.label }}
              </div>
              <button
        ...
        <div class="desktop-title-bar__divider" />
        <div
          class="desktop-title-bar__menu-group"
          data-menu="project"
        >
          ...
          >
            <span class="i-lucide-library-big h-3.5 w-3.5 shrink-0" />
            <span class="desktop-title-bar__project-label">{{ projectLabel }}</span>
            <span class="i-lucide-chevron-down h-3 w-3 shrink-0" />
          </button>
          <div
            v-if="openMenu === 'project'"
            class="desktop-title-bar__dropdown desktop-title-bar__dropdown--project"
            role="menu"
          >
            <button
            ...
            >
              <span
                :class="item.projectRoot === null ? 'i-lucide-library' : 'i-lucide-book-open-text'"
                class="h-3.5 w-3.5 shrink-0"
              />
              <span class="min-w-0 flex-1 truncate">{{ item.label }}</span>
              <span
                v-if="item.active"
                class="i-lucide-check h-3.5 w-3.5 shrink-0"
              />
            </button>
          </div>
        </div>
      ...
      <div
        class="desktop-title-bar__center desktop-title-bar__drag-surface"
        data-tauri-drag-region
        :title="title"
      >
        <button
      ...
      <div
        ref="navigationMeasureRef"
        class="desktop-title-bar__navigation-measure"
        aria-hidden="true"
      >
      ...
      <div
        ...
        class="desktop-title-bar__window-controls"
      >
        <button
          type="button"
          aria-label="Minimize"
        ...
        <button
          type="button"
          aria-label="Maximize"
          @click="windowCommand('toggle-maximize')"
        >
          <span class="i-lucide-square h-3.5 w-3.5" />
        </button>
        <button
          type="button"
          class="desktop-title-bar__close"
          aria-label="Close"
          @click="windowCommand('close')"
        >
