  ...
  >
    ...
    <div class="relative shrink-0">
      ...
      <input
        v-model="keyword"
        type="text"
        class="w-full rounded-lg border border-[var(--border-color)] bg-[var(--bg-input)] py-2 pl-8 pr-3 text-sm text-[var(--text-main)] outline-none focus:border-[var(--accent-main)]"
        placeholder="搜索 lucide 图标名，例如 map、book、user..."
      >
    </div>
    ...
    <div
      ...
      class="rounded-lg border border-dashed border-[var(--border-color)] py-8 text-center text-xs text-[var(--text-muted)]"
    >
      没有匹配的图标
    </div>
  </Dialog>
