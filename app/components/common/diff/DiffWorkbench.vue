  ...
  <div class="diff-workbench">
    <header class="diff-workbench__header">
      <div class="min-w-0">
        ...
        <div
          v-if="document.path"
          class="mt-1 truncate font-mono text-xs text-[var(--text-muted)]"
        >
          {{ document.path }}
        </div>
      </div>
    ...
    <section class="diff-workbench__body">
      <div
        v-if="!isDiffable"
        class="diff-workbench__unavailable"
      >
        <div class="diff-workbench__unavailable-icon">
          <span class="i-lucide-file-warning h-5 w-5" />
        </div>
        <div class="min-w-0">
          ...
          <p
            v-if="document.notice"
            class="mt-2 max-w-[720px] text-xs leading-6 text-[var(--text-secondary)]"
          >
            {{ document.notice }}
          </p>
