...
<template>
  ...
  <div
    class="inline-flex max-w-full rounded-md border border-[var(--border-color)] bg-[var(--bg-input)] p-0.5"
    :class="props.wrap ? 'flex-wrap' : 'flex-nowrap'"
  >
    <button
    ...
    >
      ...
      <span
        ...
        class="shrink-0 font-mono text-[10px] opacity-80"
      >{{ option.count }}</span>
    </button>
  </div>
</template>
