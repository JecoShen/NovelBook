  ...
  >
    ...
    >
      <div class="flex min-w-0 flex-1 items-center">
        <div
          v-if="showFormatTools"
          class="structured-text-editor__format-tools flex min-w-0 items-center gap-0.5 overflow-hidden text-[var(--text-muted)]"
        >
          <button
      ...
      <div
        class="flex shrink-0 items-center border border-[var(--border-color)] bg-[var(--bg-panel)] text-[var(--text-muted)]"
        :class="modeGroupClass"
      >
        <button
    ...
    <div
      class="structured-text-editor__body min-h-0 overflow-hidden"
      :class="canResize ? 'structured-text-editor__body--resizable' : ''"
      :style="bodyStyle"
    >
