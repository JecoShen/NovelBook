...
<template>
  ...
  >
    ...
    >
      ...
      <div class="markdown-selection-menu__divider" />
      ...
      <div class="markdown-selection-menu__group">
        ...
        >
          <span
            :class="currentTextOption.iconClass"
            class="h-3.5 w-3.5"
          />
        ...
        <div
          v-if="textMenuOpen"
          class="markdown-selection-menu__dropdown markdown-selection-menu__dropdown--text"
        >
          <button
      ...
      >
        <span class="i-lucide-underline h-3.5 w-3.5" />
      </button>
      <button
        type="button"
        class="markdown-selection-menu__button markdown-selection-menu__button--icon"
      ...
      <button
        type="button"
        class="markdown-selection-menu__button markdown-selection-menu__button--icon"
        :title="t('markdownStudio.selection.link')"
        @click="void setLink()"
      >
      ...
      <button
        type="button"
        class="markdown-selection-menu__button markdown-selection-menu__button--icon"
        :title="t('markdownStudio.selection.addComment')"
        @click="closeDropdowns(); emit('add-comment')"
      >
      ...
      <button
        type="button"
        class="markdown-selection-menu__button markdown-selection-menu__button--icon"
        :title="t('markdownStudio.selection.image')"
        @click="closeDropdowns(); emit('insert-image')"
      >
        <span class="i-lucide-image h-3.5 w-3.5" />
      </button>
      ...
      <div class="markdown-selection-menu__group">
        ...
        >
          <span
            class="markdown-selection-menu__letter-a"
            :style="{ color: currentTextColor || undefined, backgroundColor: currentHighlightColor || undefined }"
          >A</span>
          <span class="i-lucide-chevron-down h-2.5 w-2.5" />
        </button>
        <div
          v-if="colorMenuOpen"
          class="markdown-selection-menu__dropdown markdown-selection-menu__dropdown--color"
        >
          <div class="markdown-selection-menu__palette-title">
            {{ t("markdownStudio.selection.textColor") }}
          </div>
          <div class="markdown-selection-menu__palette-grid">
            ...
            >
              <span
                class="markdown-selection-menu__swatch-letter"
                :style="{ color: color.value || 'var(--text-secondary)' }"
              >A</span>
            </button>
          </div>

          <div class="markdown-selection-menu__palette-title">
            {{ t("markdownStudio.selection.highlightColor") }}
          </div>
          <div class="markdown-selection-menu__palette-grid">
            <button
            ...
            >
              <span
                class="markdown-selection-menu__swatch-dot"
      ...
      <div class="markdown-selection-menu__group">
        <button
          type="button"
          class="markdown-selection-menu__button markdown-selection-menu__button--icon"
          :title="t('markdownStudio.selection.moreFormatting')"
          @click="toggleDropdown('more')"
        >
          <span class="i-lucide-ellipsis-vertical h-3.5 w-3.5" />
        </button>
        <div
          v-if="moreMenuOpen"
          class="markdown-selection-menu__dropdown markdown-selection-menu__dropdown--more"
        >
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
          ...
          >
            <span class="i-lucide-superscript h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
          ...
          >
            <span class="i-lucide-subscript h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
          ...
          >
            <span class="i-lucide-languages h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
          ...
          >
            <span class="i-lucide-letter-text h-3.5 w-3.5" />
          </button>
          <div class="markdown-selection-menu__divider" />
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
            :title="t('markdownStudio.selection.alignLeft')"
            @click="applyAlign('left')"
          >
            <span class="i-lucide-align-left h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
            :title="t('markdownStudio.selection.alignCenter')"
            @click="applyAlign('center')"
          >
            <span class="i-lucide-align-center h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
            :title="t('markdownStudio.selection.alignRight')"
            @click="applyAlign('right')"
          >
            <span class="i-lucide-align-right h-3.5 w-3.5" />
          </button>
          <button
            type="button"
            class="markdown-selection-menu__button markdown-selection-menu__button--icon"
            :title="t('markdownStudio.selection.alignJustify')"
            @click="applyAlign('justify')"
          >
            <span class="i-lucide-align-justify h-3.5 w-3.5" />
          </button>
          <div class="markdown-selection-menu__divider" />
          <button
            type="button"
