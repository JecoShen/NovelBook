    ...
    >
      ...
      >
        <div
          ...
          class="absolute bottom-0 left-0 top-0 w-0.5 bg-[var(--accent-main)]"
        />
        <div
          v-if="isDropTarget(tab, true, 'after')"
          class="absolute bottom-0 right-0 top-0 w-0.5 bg-[var(--accent-main)]"
        />
        <span
        ...
        <button
          type="button"
          class="-mr-1 flex h-5 w-5 shrink-0 items-center justify-center rounded opacity-0 hover:bg-[var(--bg-hover)] group-hover:opacity-100"
          :title="t('markdownStudio.toolbar.close')"
    ...
    <div class="flex min-h-9 shrink-0 items-end gap-2 px-2">
      ...
      <div class="flex h-[34px] shrink-0 items-center gap-1 text-[var(--text-muted)]">
        <div
          ...
          class="flex items-center rounded-md border border-[var(--border-color)] bg-[var(--bg-input)] p-0.5"
        >
          <button
        ...
        <button
          ...
          :title="t('markdownStudio.toolbar.more')"
          @click="emit('more')"
        >
