    ...
    <section class="rounded-[28px] border border-[var(--border-color)] bg-[var(--bg-panel)] px-5 py-5 shadow-[0_18px_60px_color-mix(in_srgb,var(--shadow-color)_8%,transparent)]">
      <div class="flex flex-col gap-4 xl:flex-row xl:items-start xl:justify-between">
        <div class="max-w-[900px]">
          <div class="text-[11px] uppercase tracking-[0.28em] text-[var(--text-muted)]">
            Plot Timeline
          </div>
          <div class="mt-2 text-2xl font-semibold text-[var(--text-main)]">
        ...
        <div class="grid gap-3 sm:grid-cols-4">
          <div class="rounded-[22px] border border-[var(--border-color)] bg-[var(--bg-input)] px-4 py-3">
            ...
            <div class="mt-1 text-lg font-semibold text-[var(--text-main)]">
              {{ props.timeline.threads.length }}
            </div>
          </div>
          <div class="rounded-[22px] border border-[var(--border-color)] bg-[var(--bg-input)] px-4 py-3">
            <div class="text-[10px] uppercase tracking-[0.18em] text-[var(--text-muted)]">
