...
<template>
  ...
  />
  <input
    v-else-if="inputKind === 'hidden'"
    class="h-7 w-full min-w-0 rounded border border-[var(--we-border)] bg-[var(--we-bg-muted)] px-2 font-mono text-[11px] text-[var(--we-text-muted)] opacity-70"
    disabled
    value="remove"
  >
  <FormSelect
