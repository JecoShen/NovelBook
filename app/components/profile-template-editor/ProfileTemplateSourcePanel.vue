...
<template>
  ...
  <section
    ...
    :class="props.embedded ? 'h-full border-0 bg-transparent p-0 shadow-none' : 'flex-[0.9]'"
  >
    <div
      v-if="!props.embedded"
      class="mb-2 flex shrink-0 items-center justify-between"
    >
