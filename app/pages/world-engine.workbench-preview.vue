...
const selectedSliceSubjectFileProposalCount = computed(() => selectedSlice.value
...
<template>
  <div class="world-engine-workbench-preview world-engine-workbench-theme flex h-screen flex-col overflow-hidden bg-[var(--we-bg-canvas)] text-[var(--we-text-main)]">
    ...
    <header class="flex h-14 shrink-0 items-center gap-3 border-b border-[var(--we-border)] bg-[var(--we-bg-panel)] px-4 shadow-[0_1px_0_color-mix(in_srgb,var(--shadow-color)_4%,transparent)]">
      ...
      <div class="min-w-0">
        <div class="text-[15px] font-semibold leading-5 text-[var(--we-text-main)]">
      ...
      <div class="ml-auto flex items-center gap-2">
        <span class="hidden items-center gap-1.5 rounded-md border border-[var(--we-border)] bg-[var(--we-bg-subtle)] px-2.5 py-1 text-[11px] text-[var(--we-text-secondary)] md:inline-flex">
          <span class="h-1.5 w-1.5 rounded-full bg-[var(--we-accent)]" />
          已同步，slice index 新鲜
        </span>
        <span class="hidden items-center gap-1.5 rounded-md border border-[var(--we-accent-border)] bg-[var(--we-accent-soft)] px-2.5 py-1 text-[11px] text-[var(--we-accent-strong)] xl:inline-flex">
          <span class="i-lucide-hard-drive h-3.5 w-3.5" />
          {{ localDraftLabel }}
        </span>
        ...
        >
          ...
          <span
            v-if="metadataDraftSliceCount"
            class="hidden rounded border border-[var(--we-warning-border)] bg-[var(--we-bg-panel)] px-1.5 py-0.5 font-mono text-[10px] md:inline"
          >meta {{ metadataDraftSliceCount }}</span>
          <span
            v-if="valueDraftSliceCount"
            class="hidden rounded border border-[var(--we-warning-border)] bg-[var(--we-bg-panel)] px-1.5 py-0.5 font-mono text-[10px] md:inline"
          >value {{ valueDraftSliceCount }}</span>
        </button>
        <button
          type="button"
          class="inline-flex h-8 items-center gap-1.5 rounded-md border border-[var(--we-border)] bg-[var(--we-bg-panel)] px-3 text-[12px] text-[var(--we-text-secondary)] transition-colors hover:bg-[var(--we-bg-hover)] hover:text-[var(--we-text-main)]"
          @click="resetMockData"
        >
        ...
        >
          ...
          <span
            v-if="metadataDraftSliceCount"
            class="rounded border border-[var(--we-warning-border)] bg-[var(--we-warning-soft)] px-1.5 py-0.5 font-mono text-[10px] font-semibold text-[var(--we-warning)]"
          >meta {{ metadataDraftSliceCount }}</span>
          <span
