...
期望: 输出 `[P1-4 baseline] 扫描完成: 0/60 章含 ## 场景 段 (0%)` + exit code 0
...
实测结果 (符合预期):
- V1+V2 60 章 ## 场景 段覆盖率: 0%
- V1 (ch-001 ~ ch-030) 0/30 含 ## 场景
- V2 (ch-031 ~ ch-060) 0/30 含 ## 场景
- 6 问子标题频次全 0
...
期望: 现有 llmlint 测试全 pass + 60 章 beat 字段 100% 命中
...
- V2 (ch-031 ~ ch-060): 0/30 章含 ## 场景 段 (0%)
