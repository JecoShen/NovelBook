...
describe("World Engine IDE entry", () => {
    it("保留 Activity Bar 入口并打开当前 Project 的工作台", async () => {
        ...
        expect(workbench).toContain("打开工作区文件会关闭工作台并放弃这些会话草稿");
        ...
        expect(workbench).toContain("function blockSliceComposerSaving(message = \"切片编辑器正在保存，请稍候再切换工作台上下文。\"): boolean");
        expect(workbench).toContain("function blockWorkbenchActionBusy(message = \"世界引擎工作台正在同步，请稍候再操作。\"): boolean");
        expect(workbench).toContain("if (blockSliceComposerSaving(\"切片编辑器正在保存，请稍候再删除切片。\")) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再删除切片。\")) {");
        expect(workbench).toContain("if (blockSliceComposerSaving(\"切片编辑器正在保存，请稍候再同步主体系统。\")) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再同步主体系统。\")) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再新建切片。\")) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再编辑其它切片。\")) {");
        ...
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再切换主体过滤。\")) {");
        expect(workbench).toContain("function updateSliceSearchForTimeline(value: string): void {\n    if (blockSliceComposerSaving()) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再搜索时间线。\")) {");
        expect(workbench).toContain("function updateSliceKindFilterForTimeline(filter: string): void {\n    if (blockSliceComposerSaving()) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再切换类型过滤。\")) {");
        ...
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再切换状态过滤。\")) {");
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再查看草稿。\")) {");
        expect(workbench).toContain(":busy=\"workbenchActionBusy\"");
        ...
        expect(workbench).toContain("新建切片");
        ...
        expect(workbench).toContain("编辑切片");
        expect(workbench).toContain("删除切片");
        ...
        expect(workbench).toContain("aria-label=\"关闭切片编辑器\"");
        expect(workbench).toContain("data-testid=\"world-workbench-close\"");
        expect(workbench).toContain("aria-label=\"关闭世界引擎工作台\"");
        expect(workbench).toContain("当前切片编辑器有未保存草稿，确定关闭吗？");
        expect(workbench).toContain("切片编辑器正在保存，请稍候再关闭。");
        expect(workbench).toContain("切片编辑器正在保存，请稍候再关闭工作台。");
        expect(workbench).toContain("世界引擎工作台正在同步，请稍候再关闭工作台。");
        expect(workbench).toContain("世界引擎工作台正在同步，请稍候再打开工作区文件。");
        expect(workbench).toContain("世界引擎工作台正在同步，请稍候再打开预览。");
        ...
        expect(workbench).toContain("if (blockWorkbenchActionBusy(\"世界引擎工作台正在同步，请稍候再打开预览。\")) {");
        ...
        expect(workbench).toContain("!await confirmDialog(\"当前切片编辑器有未保存草稿，确定关闭吗？\", \"切片编辑器草稿未保存\")");
        expect(workbench).toContain("当前工作台有未保存内容：${unsavedLabels.join(\"、\")}。确定关闭并放弃吗？");
        expect(workbench).toContain("世界引擎草稿未保存");
        ...
        expect(workbench).toContain("主体 ${subjectName} 尚未接入世界引擎。请先同步主体系统");
        expect(workbench).toContain("当前项目还没有世界引擎主体。请先创建主体或同步主体系统。");
        expect(workbench).toContain("const pendingSubjectTimelineNoticePrefix = \"待接入主体暂无世界引擎时间线\";");
        ...
        expect(mutationListControls).toContain("上移所选变更");
        expect(mutationListControls).toContain("下移所选变更");
        ...
        expect(objectValueEditor).toContain("嵌套对象字段需要填写 JSON 对象");
        ...
        expect(mutationBuilder).toContain("当前值需要填写 JSON 对象");
        ...
        expect(timeline).toContain("搜索标题 / 时刻 / 摘要 / 变更");
        expect(timeline).toContain("没有匹配当前搜索条件的切片");
        expect(timeline).toContain("当前主体");
        expect(timeline).toContain("edit-slice");
        expect(timeline).toContain("aria-label=\"编辑切片\"");
