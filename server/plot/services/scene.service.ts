...
import { throwPlotNotFound, throwPlotBadRequest } from 'nbook/server/plot/core/errors'
...
import type { RefResolverService } from 'nbook/server/plot/services/ref-resolver.service'
import type { SceneWorldAnchorValidator } from 'nbook/server/plot/services/scene-world-anchor.validator'
